...
using DgERM.EntityFrameworkCore.Seed;
...
namespace DgERM.EntityFrameworkCore
{
    ...
    public class DgERMEntityFrameworkModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DgERMEntityFrameworkModule).GetAssembly());
        }
